...
function create(){
	if ($this->input->post('ActorFullName')){
		if($this->mActors->AddActor($_POST['ActorFullName'], $_POST['ActorNotes'])){
// $this->load->view('dashboard');
			redirect('film/actor/dashboard_admin/index','refresh');
	...
	$data['title'] = "Create Actors";
	$data['main'] = 'actor_create';
	$data['ActorFullName'] = $this->mActors->getTopActors();
	$this->load->vars($data);
